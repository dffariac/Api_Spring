...
* The original package name 'br.com.api-java.Projeto' is invalid and this project uses 'br.com.apijava.Projeto' instead.
...
```
$ docker run --rm -p 8080:8080 Projeto:0.0.1-SNAPSHOT
```
